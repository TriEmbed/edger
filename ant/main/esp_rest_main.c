...
initialise_mdns (void)
{
  ...
  ESP_ERROR_CHECK (mdns_service_add
		   ("ESP32-ANT-WebServer", "_http", "_tcp", 80,
		    serviceTxtData,
...
whichBoard ()
{
  ...
  ESP_LOGI (TAG,"Ethernet MAC 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x",
	    device.derived_mac_addr[0], device.derived_mac_addr[1],
	    device.derived_mac_addr[2], device.derived_mac_addr[3],
	    device.derived_mac_addr[4], device.derived_mac_addr[5]);

printf("%x \n\n",(uint16_t)device.value);
